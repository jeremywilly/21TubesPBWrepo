...
class MySQLDB
{
    ...
    public function executeSelectRamen($sql, $nama)
    {
        $this->openConnection();
        $query_result = $this->db_connection->query($sql);
        $result = [];
        ...
        $_SESSION['namaRamen'] = $nama;
        $this->closeConnection();
        return $result;
    }

    public function executeSelectResto($sql, $nama)
    {
        $this->openConnection();
        $query_result = $this->db_connection->query($sql);
        $result = [];
    ...
    {
        $this->openConnection();
        $query_result = $this->db_connection->query($sql); //boolean
        $this->closeConnection();
        return $query_result;
    }
...
$db = new MySQLDB("localhost", "root", "", "delivery");
